...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../AES.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../AES.gen/sources_1/ip/vio_0/hdl" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../AES.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../AES.gen/sources_1/ip/vio_0/hdl" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dell/Desktop/FPGA/VivadoProjects/FPGA_project/AES/AES.cache/compile_simlib/xcelium"
  fi
