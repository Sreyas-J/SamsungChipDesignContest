...
#
# Script generated by Vivado on Fri Nov 01 13:24:49 IST 2024
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../AES.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../AES.gen/sources_1/ip/vio_0/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../AES.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../AES.gen/sources_1/ip/vio_0/hdl" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dell/Desktop/FPGA/VivadoProjects/FPGA_project/AES/AES.cache/compile_simlib/vcs"
  fi
